...
import { motion, AnimatePresence } from 'framer-motion'
import { ArrowRight, ArrowLeft, Loader2, MoreHorizontal, AlertCircle } from 'lucide-react'
      ...
      >
        <div className="border border-zinc-800 bg-[#050505]/50 backdrop-blur-sm p-8 md:p-10 relative group">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            {/* Error Display */}
            {error && (
              <div className="p-3 bg-red-500/10 border border-red-500/20 text-red-500 text-sm text-center flex items-center justify-center gap-2">
