...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadWatchlist() async {
    ...
    final list = prefs.getStringList('my_watchlist') ?? [];
    setState(() {
      _watchlist.clear();
      _watchlist.addAll(list.map((e) => int.tryParse(e) ?? 0));
    });
  }
  ...
  Future<void> _toggleWatchlist(int id) async {
    ...
    await prefs.setStringList('my_watchlist', _watchlist.map((e) => e.toString()).toList());
  }
            ...
            title: Row(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.movie_filter, color: Colors.black, size: 16),
                ),
                  ...
                  child: ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: CachedNetworkImage(
                        ...
                        fit: BoxFit.cover,
                        errorWidget: (_, __, ___) => Container(color: const Color(0xFF141414)),
                      ),
                    ),
                  ),
                );
